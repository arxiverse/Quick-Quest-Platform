...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleClick = (
    ...
    if (onChange) onChange(index, items[index].label);
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.6em] px-[1em] inline-flex flex-col items-center justify-center gap-0.5"
                >
                  {item.icon && <div className="z-10">{item.icon}</div>}
