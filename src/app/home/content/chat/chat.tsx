      ...
      <Surface className="p-4 sm:p-5">
        <div className="space-y-3">
          {chatPreviews.map((chat) => (
            <button key={`${chat.name}-${chat.time}`} type="button" className="flex w-full items-start gap-3 rounded-[14px] border border-base-300/70 bg-base-100 p-3 text-left transition-colors hover:bg-base-200/70">
