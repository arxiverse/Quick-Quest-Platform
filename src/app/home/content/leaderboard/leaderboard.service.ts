...
export const LEADERBOARD_ALL_SKILL_SEED = "Semua Skill";

export const leaderboardProfileQueryKeysSeed = [
  "lbPanel",
  "lbRunner",
  "lbScope",
  "lbPeriod",
...
export const leaderboardPeriodConfigSeed: Record<
  LeaderboardPeriod,
  { pp: number; shift: number; prefix: string }
> = {
...
export type LeaderboardViewCopy = {
  hero: {
    eyebrow: string;
    title: string;
  };
  filters: {
    runnerSearchPlaceholder: string;
    emptyRowsMessage: string;
  };
  table: {
    headers: string[];
    actionViewProfile: string;
  };
  snapshot: {
    eyebrow: string;
    notFoundMessage: string;
    deepPanelButton: string;
  };
  chart: {
    rankValuePrefix: string;
  };
  feed: {
    eyebrow: string;
  };
...
export const leaderboardViewCopySeed: LeaderboardViewCopy = {
  hero: {
    eyebrow: "Public Leaderboard",
    title: "Ranking Runner Terbuka + Segmented Filter + View Profile Panel",
  },
  filters: {
    runnerSearchPlaceholder: "Cari runner publik...",
    emptyRowsMessage: "Data runner tidak ditemukan untuk filter aktif.",
  },
  table: {
    headers: [
      "Rank",
  ...
  snapshot: {
    eyebrow: "Runner Snapshot",
    notFoundMessage: "Runner tidak ditemukan.",
    deepPanelButton: "View Profile Deep Panel",
  },
  chart: {
    rankValuePrefix: "Rank",
  },
  feed: {
    eyebrow: "Public Feed",
  },
  panel: {
    eyebrow: "Runner Public Profile",
    closeButton: "Tutup",
    scopePrefix: "Scope:",
    periodPrefix: "Period:",
  },
