export const CohortRetentionSeed = {
  eyebrow: "Giver Analysis",
  title: "Cohort Retention",
  description: "Retensi cohort runner/giver untuk menilai kualitas pengalaman jangka panjang.",
  chips: [
  ...
  points: [
    {
      title: "Context",
      detail: "Retensi cohort runner/giver untuk menilai kualitas pengalaman jangka panjang.",
    },
    {
