export const ScopeAnalyticsSeed = {
  eyebrow: "Giver Analysis",
  title: "Scope Analytics",
  description: "Analisis radius, kandidat, dan area panas agar matching lebih efisien.",
  chips: [
  ...
  points: [
    {
      title: "Context",
      detail: "Analisis radius, kandidat, dan area panas agar matching lebih efisien.",
    },
    {
