export const SlaResponseSeed = {
  eyebrow: "Runner Analysis",
  title: "SLA & Response",
  description: "Pemantauan median response, target SLA, serta outlier yang perlu eskalasi.",
  chips: [
  ...
  points: [
    {
      title: "Context",
      detail: "Pemantauan median response, target SLA, serta outlier yang perlu eskalasi.",
    },
    {
