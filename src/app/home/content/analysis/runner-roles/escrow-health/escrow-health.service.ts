export const EscrowHealthSeed = {
  eyebrow: "Runner Analysis",
  title: "Escrow Health",
  description: "Distribusi state escrow dan aging untuk menjaga keamanan arus dana.",
  chips: [
  ...
  points: [
    {
      title: "Context",
      detail: "Distribusi state escrow dan aging untuk menjaga keamanan arus dana.",
    },
    {
