...
export function QuestDetail({
  ...
  const quest =
    liveQuestItems.find((q) => q.title === questId) || liveQuestItems[0];
  ...
  return (
    <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <Surface className="p-5 sm:p-7 overflow-hidden relative">
        ...
        <h1 className="mt-4 text-2xl sm:text-4xl font-bold text-base-content tracking-tight">
          {quest.title}
        </h1>
        ...
        <div className="mt-6 grid sm:grid-cols-2 gap-4 relative z-10">
          ...
          <div className="rounded-[12px] border border-[#10B981]/20 bg-linear-to-br from-[#10B981]/5 to-transparent p-4 flex flex-col justify-center">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-base-content/50">
              Estimasi Upah Dasar
            </p>
        ...
        <div className="mt-6 space-y-4">
          ...
          <ul className="list-disc pl-5 text-sm text-base-content/70 space-y-2.5">
            <li>
              Diutamakan bagi Runner dengan score Performance Points (PP)
              minimal{" "}
            ...
            <li>
              Wajib hadir di lokasi maksimal{" "}
              <strong className="text-base-content font-bold">
            ...
            <li>
              Tugas membutuhkan skill fisik untuk tipe quest{" "}
              <strong className="text-base-content font-bold">
                {quest.mode}
              </strong>{" "}
              dengan target kategori{" "}
              <strong className="text-base-content font-bold">
                {quest.category}
              </strong>
              .
            ...
            <li>
              <span className="bg-[#DCFCE7] text-[#166534] px-1.5 py-0.5 rounded font-bold">
                Escrow Secured:
              </span>{" "}
              Pihak Giver ({quest.owner}) sudah menahan dana sebesar nilai upah
              di dalam brankas sistem.
            </li>
          </ul>
        </div>
        ...
        <div className="mt-6 rounded-[16px] border border-base-300/70 bg-[#0F172A] p-4 text-white relative overflow-hidden">
          ...
          />
          <p className="relative z-10 text-[11px] font-bold uppercase tracking-wider text-[#38BDF8]">
            Mode Radar Target Lokasi
          </p>
          <div className="relative z-10 mt-4 flex h-40 sm:h-48 items-center justify-center">
            ...
            <div
              className="absolute size-32 sm:size-40 rounded-full border-2 border-red-500/50 animate-ping"
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 border-t border-base-200 pt-6">
          <button
            type="button"
            className="btn h-12 flex-1 rounded-[10px] border-none bg-[#6B21FF] text-white hover:bg-[#6B21FF]/90 text-sm sm:text-base font-bold shadow-lg shadow-[#6B21FF]/30 transition-transform active:scale-95"
          >
            Terima & Mulai Quest
          </button>
          <button
            type="button"
            className="btn h-12 flex-1 rounded-[10px] border border-base-300 bg-base-100 text-base-content hover:bg-base-200 text-sm sm:text-base transition-transform active:scale-95"
          >
