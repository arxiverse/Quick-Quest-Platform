...
export function RunnerImpactDetail({ onBack }: { onBack: () => void }) {
  return (
      ...
      <Surface className="p-5 sm:p-6 relative bg-base-100 border border-base-300 shadow-xl">
        ...
        <div className="min-h-[400px] flex flex-col items-center justify-center rounded-[12px] bg-base-200/50 border-2 border-dashed border-base-300 p-8 text-center gap-3">
          ...
          <h3 className="font-bold text-lg text-base-content">
            Nested SPA: Lapis 2 Terbuka!
          </h3>
          <p className="text-sm font-medium text-base-content/60 max-w-md">
            Ini adalah ruang observasi khusus (ESVMC Container) buat metrics impact sang Runner. Di sini nanti lo bisa tumpuk grafik chart, riwayat kontribusi detail, sampai log pendapatan kumulatif tanpa bikin Dashboard utama meledak!
          </p>
        </div>
      </Surface>
    </div>
