      ...
      <Surface className="p-5 sm:p-7 relative overflow-hidden border border-success/30 shadow-xl max-w-5xl mx-auto w-full">
        ...
        <div>
          <h1 className="text-2xl font-bold text-base-content tracking-tight">
            Financial Hub & Settlement
          </h1>
          <p className="text-sm text-base-content/60 mt-1">
            Cairkan saldo upah QQM Anda ke Rekening Bank atau E-Wallet dalam
            hitungan menit.
          </p>
        </div>
          ...
          <div className="space-y-6">
            {animationsEnabled ? (
              <ElectricBorder
                ...
                borderRadius={16}
              >
                <div className="p-6 rounded-[16px] bg-linear-to-tr from-[#166534] to-[#22C55E] text-white shadow-lg shadow-success/20">
                  <p className="text-[10px] uppercase tracking-[0.2em] opacity-80">
                    Total Saldo Tersedia (Net Amount)
                  </p>
                  <h2 className="mt-2 text-4xl font-black font-mono">
                    Rp 18.600.000
                  </h2>
                  <div className="mt-6 flex items-center gap-4">
                    <span className="bg-black/20 px-3 py-1 text-xs rounded-[6px] backdrop-blur font-bold font-mono border border-white/10">
                      ESCROW CLEARED
                    </span>
                    <span className="text-xs opacity-75">
                      Tersedia ditarik kapan saja 24/7.
                    </span>
                  </div>
                </div>
              </ElectricBorder>
            ...
            <h3 className="text-sm font-bold text-base-content border-b border-base-200 pb-2 mt-8">
              Pilih Metode Tujuan Pencairan
            </h3>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative rounded-[12px] border-2 border-success bg-success/5 p-4 cursor-pointer">
                ...
                <p className="text-xs font-semibold text-base-content mt-1">
                  Rp 0 Fee Instan
                </p>
              </div>
              <div className="rounded-[12px] border border-base-300 bg-base-100 p-4 cursor-pointer hover:border-base-300/80 transition-colors">
                <p className="text-lg font-black italic text-[#005E6A]">
                  Mandiri
                </p>
                <p className="text-xs font-semibold text-base-content mt-1">
                  Rp 0 Fee Instan
              ...
              <div className="rounded-[12px] border border-base-300 bg-base-100 p-4 cursor-pointer hover:border-base-300/80 transition-colors">
                <p className="text-lg font-black italic text-[#0B5C95]">
                  GOPAY
                </p>
                <p className="text-xs font-semibold text-base-content mt-1">
                  Admin + Rp 1.500
            ...
            <div className="mt-6 form-control w-full">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-lg text-base-content/50">
                  Rp
                </span>
                <input
                  type="tel"
                  className="input input-lg w-full pl-12 font-bold text-2xl font-mono border-base-300 focus:border-success bg-base-100 placeholder:text-base-300"
                  placeholder="0"
              ...
              <label className="label">
                ...
                <button className="label-text-alt font-bold text-success hover:underline">
                  Tarik Semua
                </button>
              </label>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-[12px] bg-base-200 border border-base-300 p-5">
              ...
              <Magnet
                ...
                magnetStrength={3}
              >
                <button className="magnet-btn btn btn-block bg-success hover:bg-success/90 text-white font-bold border-none mt-6 h-12 shadow-md shadow-success/20 cursor-none">
            ...
            <div className="rounded-[12px] bg-warning/10 border border-warning/30 p-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-warning-content/80 mt-1.5 leading-relaxed">
                    Dana ini adalah pencairan sah hasil dari keringat *Runner*
                    yang telah divalidasi dan bukan berasal dari uang hasil
                    money laundry. Seluruh KYC Settlement telah disetujui OJK.
                  </p>
                </div>
              </div>
            </div>
