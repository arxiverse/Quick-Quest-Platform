    ...
    return (
      <Surface className="p-3 sm:p-4">
        <div className="flex items-center gap-2">
          <label className="input input-bordered flex h-12 w-full items-center gap-3 rounded-[10px] border-base-300 bg-base-100 px-4 text-base-content shadow-none transition-colors focus-within:border-primary/40 sm:h-12">
      ...
      <Surface className="overflow-hidden p-4 sm:p-5">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-2 text-2xl font-bold leading-tight text-base-content sm:text-3xl xl:max-w-[16ch] xl:text-[2rem]">
              {meta.title}
            </h1>
          ...
          <div className="flex items-center justify-end xl:min-w-56 xl:pt-1">
            <SwitchTheme />
          </div>
        </div>
      </Surface>
