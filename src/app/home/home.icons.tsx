...
export function ShieldIcon({ className }: HomeIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      <path d="M12 3L4.5 6V12C4.5 16.14 7.82 19.97 12 21C16.18 19.97 19.5 16.14 19.5 12V6L12 3Z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 12L11 14L15.5 9.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
