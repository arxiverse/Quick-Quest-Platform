  ...
  return (
    <form className="auth-card w-full max-w-full p-6 sm:p-10" onSubmit={handleSubmit}>
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <h1 className="auth-section-title text-base-content">{loginViewText.title}</h1>
      </div>
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-3 text-xs">
        <label className="flex min-w-0 cursor-pointer items-center gap-2 text-base-content/80">
          ...
          <span className="label-text text-base-content/80">{loginViewText.rememberLabel}</span>
        </label>
      ...
      >
        {isSubmitting ? loginViewText.submittingLabel : loginViewText.submitLabel}
      </button>

      <div className="mt-12 text-center">
        <div className="text-xs font-bold text-base-content/85">{loginViewText.continueWithLabel}</div>
